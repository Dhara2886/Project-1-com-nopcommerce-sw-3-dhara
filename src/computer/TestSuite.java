...
//            2.20 Verify the Text “Welcome, Please Sign In!”
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"),"Manish");   //insert username
        sendTextToElement(By.id("BillingNewAddress_LastName"),"Tyagi");         //insert lastname
        sendTextToElement(By.id("BillingNewAddress_Email"),"manishtyagi1211@gmail.com");    //insert random email id
        selectByValueFromDropDown(By.id("BillingNewAddress_CountryId"),"233");   //select your country
        Thread.sleep(1000);
        sendTextToElement(By.id("BillingNewAddress_City"),"Harrow");   //insert city name
        sendTextToElement(By.id("BillingNewAddress_Address1"),"909 Halifax Road");   //insert address
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"),"ha3 5hj");           //insert postcode
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"),"07098678901");     //enter user phone number
        Thread.sleep(2000);
