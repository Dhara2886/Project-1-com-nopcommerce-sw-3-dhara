...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("FirstName"), "Manis");                                                       //Enter first name
        sendTextToElement(By.id("LastName"), "Tyagi");                                                     //Enter last name
        sendTextToElement(By.id("Email"), emailID);
        selectByValueFromDropDown(By.name("DateOfBirthDay"), "15");
        selectByValueFromDropDown(By.name("DateOfBirthMonth"), "11");
        selectByValueFromDropDown(By.name("DateOfBirthYear"), "1988");
        sendTextToElement(By.id("Password"), "hello123");                                                   //Enter password
        sendTextToElement(By.id("ConfirmPassword"), "hello123");                                            //Confirm password
        ...
        Thread.sleep(2000);
        // Fill the Mandatory fields
        selectByValueFromDropDown(By.id("BillingNewAddress_CountryId"), "40");
        sendTextToElement(By.id("BillingNewAddress_City"), "Harrow");
        sendTextToElement(By.id("BillingNewAddress_Address1"), "a50 ");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "100034");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "07702519802");
        // Click on “CONTINUE”
        ...
        Thread.sleep(2000);
        sendTextToElement(By.id("CardholderName"), "Manish");
        sendTextToElement(By.id("CardNumber"), "5374101301649805");
